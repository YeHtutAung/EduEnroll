  ...
  return (
    <div className="mb-8 rounded-xl border border-sky-200 bg-sky-50 p-4 text-center">
      ...
      <button
        ...
        disabled={loading}
        className="inline-flex items-center gap-2 rounded-lg bg-[#0088cc] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#006daa] transition-colors disabled:opacity-50"
      >
