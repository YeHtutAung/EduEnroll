    ...
    <main className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-red-700 mb-4">
            <span className="text-white text-2xl font-bold select-none">日</span>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="admin@nihonmoment.com"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 rounded-lg bg-red-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            >
              {loading ? (
                <>
                  <Spinner />
        ...
        <p className="mt-6 text-center text-xs text-slate-400">
          Nihon Moment © {new Date().getFullYear()} — Myanmar
        </p>
      </div>
    </main>
  );
